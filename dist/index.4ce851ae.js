...
})({"lHrtD":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "dabadec74ce851ae";
...
},{}],"4yAXj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _dao = require("./DAO");
var _daoDefault = parcelHelpers.interopDefault(_dao);
var _gestionFavoris = require("./GestionFavoris");
var _gestionFavorisDefault = parcelHelpers.interopDefault(_gestionFavoris);
var _gestionJeux = require("./GestionJeux");
var _gestionJeuxDefault = parcelHelpers.interopDefault(_gestionJeux);
class AppRechercheJeux {
    static sectionPrincipale;
    static initialisation() {
        _daoDefault.default.chargerJeuxFavoris();
        this.sectionPrincipale = document.querySelector(".sectionJeux");
        if (!this.sectionPrincipale) throw new Error("La section principale est introuvable");
        //
        const boutonRecherche = document.querySelector(".boutonRecherche");
        const boutonFavoris = document.querySelector(".boutonFavoris");
        if (!boutonRecherche) throw new Error("Le bouton Recherche est introuvable");
        boutonRecherche.addEventListener("click", _gestionJeuxDefault.default.clickBoutonRecherche.bind(_gestionJeuxDefault.default));
        boutonFavoris.addEventListener("click", _gestionFavorisDefault.default.clickBoutonMesFavoris.bind(_gestionFavorisDefault.default));
    }
...
exports.default = AppRechercheJeux;
window.onload = AppRechercheJeux.initialisation.bind(AppRechercheJeux);

},{"./DAO":"je54X","./GestionFavoris":"cVB4h","./GestionJeux":"aIfW1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"je54X":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _jeu = require("../Models/Jeu");
var _jeuDefault = parcelHelpers.interopDefault(_jeu);
class DAO {
    static #mapJeux = new Map();
    static #mapFavoris = new Map();
    static async telechargerDonneesjeux() {
        if (this.#mapJeux.size > 0) return this.#mapJeux;
        try {
            ...
            if (!listeJeux || !Array.isArray(listeJeux) || listeJeux.length === 0) throw new Error("Données non conformes");
            ...
            for(let i = 0; i < listeJeux.length; i++){
                ...
                const jeu = new _jeuDefault.default(jsonJeu);
...
},{"../Models/Jeu":"7OFcy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7OFcy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _dao = require("../js/DAO");
var _daoDefault = parcelHelpers.interopDefault(_dao);
class Jeu {
    nom = "";
    image = "";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../js/DAO":"je54X"}],"gkKU3":[function(require,module,exports) {
...
},{}],"cVB4h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _appRechercheJeux = require("./AppRechercheJeux");
var _appRechercheJeuxDefault = parcelHelpers.interopDefault(_appRechercheJeux);
var _dao = require("./DAO");
var _daoDefault = parcelHelpers.interopDefault(_dao);
class GestionFavoris {
    static clickBoutonMesFavoris() {
        const mesFavoris1 = _daoDefault.default.chargerJeuxFavoris();
        _appRechercheJeuxDefault.default.sectionPrincipale.innerHTML = "";
        const divMesFavoris = document.createElement("div");
        divMesFavoris.classList.add("divMesFavoris");
        _appRechercheJeuxDefault.default.sectionPrincipale.append(divMesFavoris);
        mesFavoris1.forEach((mesFavoris)=>{
    ...
    <div class="blockBouton">
        ...
        const boutonSupprimerFavoris = _appRechercheJeuxDefault.default.sectionPrincipale.querySelector(".boutonSupprimerFavoris");
        boutonSupprimerFavoris.onclick = ()=>{
            const confirmationSuppr = confirm(`Supprimer ${jeu.nom} ?`);
            if (confirmationSuppr) {
                _daoDefault.default.retirerFavoris(jeu);
                this.clickBoutonMesFavoris;
            }
        };
    }
}
exports.default = GestionFavoris;

},{"./AppRechercheJeux":"4yAXj","./DAO":"je54X","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aIfW1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _jeu = require("../Models/Jeu");
var _jeuDefault = parcelHelpers.interopDefault(_jeu);
...
var _dao = require("./DAO");
var _daoDefault = parcelHelpers.interopDefault(_dao);
var _divSelectionJeu = require("./Composants/divSelectionJeu");
var _divSelectionJeuDefault = parcelHelpers.interopDefault(_divSelectionJeu);
class RechercheJeux {
    static async clickBoutonRecherche() {
        _appRechercheJeuxDefault.default.afficherChargementSectionPrincipale();
        const mapJeux = await _daoDefault.default.telechargerDonneesjeux();
        _appRechercheJeuxDefault.default.sectionPrincipale.innerHTML = "";
        const divJeux = document.createElement("div");
        divJeux.classList.add("divJeux");
        _appRechercheJeuxDefault.default.sectionPrincipale.append(divJeux);
        mapJeux.forEach((jeu)=>{
            const divSelection = new _divSelectionJeuDefault.default(jeu, this.afficherFicheJeu.bind(this));
    ...
    static afficherFicheJeu(jeu) {
        ...
        _appRechercheJeuxDefault.default.sectionPrincipale.append(divFicheJeu);
        ...
        boutonAjouterFavoris.onclick = ()=>{
            _daoDefault.default.ajouterAMesFavoris(jeu);
...
exports.default = RechercheJeux;

},{"../Models/Jeu":"7OFcy","./AppRechercheJeux":"4yAXj","./DAO":"je54X","./Composants/divSelectionJeu":"jBqEj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jBqEj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _gestionFavoris = require("../GestionFavoris");
var _gestionFavorisDefault = parcelHelpers.interopDefault(_gestionFavoris);
class DivSelectionJeu {
    ...
    constructor(jeu, callBackClick){
        ...
        `;
        if (callBackClick) divJeu.onclick = ()=>{
            callBackClick(jeu);
        };
        this.div = divJeu;
    }
}
exports.default = DivSelectionJeu;

},{"../GestionFavoris":"cVB4h","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lHrtD","4yAXj"], "4yAXj", "parcelRequire94c2")

//# sourceMappingURL=index.4ce851ae.js.map
