...
})({"2asLn":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f36ffbe7012d10c7";
...
},{}],"lrQcp":[function(require,module,exports) {
(function() {
    const fetchOriginal = window.fetch;
    window.fetch = (input, init)=>{
        if (input.includes("giantbomb")) return fetchGiantBomb(input);
        else return fetchOriginal(input, init);
    };
    /**
	 *
	 * @param url
	 ...
	 */ const fetchGiantBomb = (url, init)=>{
        return new Promise((resolve, reject)=>{
            ...
            window.callbackFetchGiantBomb = (data)=>{
                ...
                response.json = async ()=>{
                    if (bodyConsomme) throw new Error("Response.json: Body has already been consumed.");
                    bodyConsomme = true;
                    return data;
                };
                response.text = async ()=>{
                    if (bodyConsomme) throw new Error("Response.text: Body has already been consumed.");
                    bodyConsomme = true;
...
},{}]},["2asLn","lrQcp"], "lrQcp", "parcelRequire94c2")

//# sourceMappingURL=index.012d10c7.js.map
